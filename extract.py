...
def extract_data() :
    ...
    run_etl( qb_client, bq_client, company_id, 'deposit', qbobj.Deposit, line_trig=True )
    ...
    run_etl( qb_client, bq_client, company_id, 'journalentry', qbobj.JournalEntry, line_trig=True )
    run_etl( qb_client, bq_client, company_id, 'payment', qbobj.Payment, line_trig=True )
    run_etl( qb_client, bq_client, company_id, 'paymentmethod', qbobj.PaymentMethod )
    run_etl( qb_client, bq_client, company_id, 'purchase', qbobj.Purchase, line_trig=True )
